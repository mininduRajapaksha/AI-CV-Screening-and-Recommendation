      ...
      <div className="max-w-[818px] lg:ml-16">
        ...
        <form onSubmit={updateProfile} className="rounded-[14px] border border-slate-200 bg-white px-9 py-[22px]">
          ...
          <div className="mt-6 flex justify-end">
            <button type="submit" className="cursor-pointer rounded-lg bg-[#172554] px-3 py-2.5 text-sm font-medium text-white hover:bg-[#1e316b]">Save Changes</button>
          </div>
        </form>
        ...
        <form onSubmit={updatePassword} className="mt-9 rounded-[14px] border border-slate-200 bg-white px-9 py-4">
          ...
          <div className="mt-6 flex justify-end">
            <button type="submit" className="cursor-pointer rounded-lg bg-[#172554] px-3 py-2.5 text-sm font-medium text-white hover:bg-[#1e316b]">Update Password</button>
          </div>
        </form>
      </div>
    </div>
